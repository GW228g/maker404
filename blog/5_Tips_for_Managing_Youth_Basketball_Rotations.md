...
- **Total playing time available**: In a standard 8-period youth game with 4 players on court, you have 32 total "player-periods" to distribute.
...
- **Colored cards or chips**: Move players between "on court" and "bench" columns
...
- **Player energy levels**: If a player is exhausted or injured, don't force them to complete their scheduled periods
...
**Ready to simplify your rotation planning?** Try our free [4v4 Rotation Planner](https://rotations.maker404.com) tool that automatically generates fair rotations and tracks playing time for you.
