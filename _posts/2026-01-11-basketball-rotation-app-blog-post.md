---
layout: post
title: "How I Built a Basketball Rotation App in One Weekend (With AI Help)"
date: 2026-01-11
...
- Generated the HTML/CSS/JavaScript structure
- Helped me troubleshoot bugs
- Suggested features I hadn't thought of (like color-coded teams and a reset button)

**I made it mine:**  
- Tweaked the design to match my needs
- Added features specific to youth basketball
- Tested it during real games and iterated

The result? A fully functional web app, hosted for free on GitHub Pages, that I use every game.

**You can try it yourself:** [rotations.maker404.com](https://rotations.maker404.com)
